"""
Django settings for horoscope_app project.
...
ROOT_URLCONF = 'horoscope_app.urls'
...
WSGI_APPLICATION = 'horoscope_app.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # Ensure this matches your local static folder
]
